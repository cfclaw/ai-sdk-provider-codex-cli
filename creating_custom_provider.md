...
ProviderV3: The top-level interface that serves as a factory for different model types
LanguageModelV3: The primary interface for text generation models
EmbeddingModelV3 and ImageModelV3: Interfaces for embeddings and image generation
ProviderV3
...
LanguageModelV3Content: The specification for what the models generate
LanguageModelV3Prompt: The specification for what you send to the model
...
Streaming Errors: Can be emitted at any point via { type: 'error', error: unknown }
Warnings: Non-fatal issues reported in stream-start and response objects
Finish Reasons: Clear indication of why generation stopped:
...
Explore the V2 types in detail at @ai-sdk/provider
